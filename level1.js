...
function allImages() {
    background.src = "../images/background/borodino.png";
    imgNap.src = "../images/models/nap1.png";
}
...
//     let x = (MainScreen.width - imgNap.width) / 15;
//     let y = (MainScreen.height - imgNap.height) / 2;
...
window.addEventListener("click", e => {
    ...
    if (
        ...
        window.location.href = 'level1Copy.html'
    }
    ...
    if (
        ...
        window.location.href = 'level1Continue.html'
    }
