...
console.log(BTN2.height, BTN2.width)
...
function allImages() {
    background.src = "../images/background/berlin.png";
    imgHit.src = "../images/models/hit1.png";
}
...
function drawLeftCharacter() {
    let x = (MainScreen.width - imgHit.width) / 15;
    let y = (MainScreen.height - imgHit.height) / 20;
    canvasContext.drawImage(imgHit, x, y);
}
...
window.addEventListener("click", e => {
    ...
    if (
        ...
        window.location.href = 'level3Copy2.html'
    }
    ...
    if (
        ...
        window.location.href = 'level3Copy.html'
    }
